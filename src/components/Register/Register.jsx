...
const Register = () => {
  ...
  const hendelRegister = (event) => {
    ...
    const confamePassword = from.confamePassword.value;

    if (password.length !== 6) {
      setError("Lenth most be 6 carecter");
    }
    if (password !== confamePassword) {
    ...
    console.log(email, password, confamePassword);
  };
        ...
        <div className="hero min-h-screen bg-base-200 px-6">
          <div className="hero-content flex-col lg:flex-col">
            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
              <form action="" onSubmit={hendelRegister}>
                <div className="card-body">
                  ...
                  <div className="form-control">
                    ...
                    />
                    <label className="label">
                      <span className="label-text">Confarme Password</span>
                    </label>
                    <input
                      type="password"
                      required
                      name="confamePassword"
                      placeholder="confarme password"
                      className="input input-bordered"
                    />
                    <label className="label">
